...
const textureNormal = textureLoader.load(
  "/textures/rock/Rock043L_1K-JPG_NormalDX.jpg"
);
const textureAO = textureLoader.load(
  "/textures/rock/Rock043L_1K-JPG_AmbientOcclusion.jpg"
);
const textureDisplacement = textureLoader.load(
  "/textures/rock/Rock043L_1K-JPG_Displacement.jpg"
);
const textureRoughness = textureLoader.load(
  "/textures/rock/Rock043L_1K-JPG_Roughness.jpg"
);
